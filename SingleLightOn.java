...
//       long pressing the home button to activate mic
        ...
        driver.findElement(By.id("com.google.android.googlequicksearchbox:id/input_text")).sendKeys("Turn on TestingLamp");
        ...
        {
            Status = "1";
            ActualResult = "Light " + lightName + " is turned on ";
            Comments = "NA";
            ExpectedResult= "Light " + lightName + " should turned on ";
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);
        } else {
            Status = "0";
            ActualResult = "Light " + lightName + " is not turned on";
