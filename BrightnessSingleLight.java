...
public class BrightnessSingleLight {
    ...
    public  void BrightnessSingleLight(AndroidDriver driver,String fileName, String APIVersion, String SWVersion) throws IOException, JSONException, InterruptedException, ParseException {
...
//       long pressing the home button to activate mic
        ...
        driver.findElement(By.id("com.google.android.googlequicksearchbox:id/input_text")).sendKeys("bright TestingLamp to 50%");
        ...
        lightStatusReturned = ob1.toString();
        ...
        if (lightStatusReturned.equals("127")) {
            Status = "1";
            ActualResult ="brightness changed for the selected light"+"\n"+lightName;
            Comments = "NA";
            ExpectedResult= " Light: "+lightName+" should change its brightness after giving command";
            ...
            Status = "0";
            ActualResult ="brightness does not changed for the selected light"+"\n"+lightName;
            Comments = "FAIL:Light is not changing its brightness";
            ExpectedResult= " Light: "+lightName+" should change its brightness after giving command";
            System.out.println("Result: " + Status + "\n" + "Comment: " + Comments+ "\n"+"Actual Result: "+ActualResult+ "\n"+"Expected Result: "+ExpectedResult);
        }
